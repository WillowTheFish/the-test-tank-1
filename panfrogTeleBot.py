# bot's username: @fishfishfishthebot
# message "/start" to start the bot up
# Make sure to run the code before messaging the bot

import telebot
from telebot import types
import random

TOKEN = "8690617110:AAEivO9mY0fKIsjW9Pin44x6UFgOqG3cOr8"
...
def secret(message):
    bot.send_message(message.chat.id, "there is no game i lied", reply_markup=startKeyboard())
